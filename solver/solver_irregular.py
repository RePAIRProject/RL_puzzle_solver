...
def initialization(R, anc, puzzle_type):  # (R, anc, anc_rot, nh, nw):
    ...
    y0 = round((Y-1) / 2)  # position for anchored patch (center)
    x0 = round((Y-1) / 2)
    ...
    while t < T and eps > 0:
        ...
        for i in range(no_patches):
            ...
            for zi in range(Z):
                ...
                q2 = (q1 + no_patches * Z * 1)
                # q2 = (q1 + no_patches) #non-rotation case
                q[:, :, zi, i] = q2
        pq = p * q
        e = 1e-11
