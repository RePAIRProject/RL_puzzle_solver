...
def main():
    ...
    cur_folder = os.path.join(dataset_path, f'random_{line_type}_exact_detection_32x32')
    ...
    for N in range(num_images):
        ...
        puzzle_image_folder = os.path.join(os.getcwd(), 'output_32x32', f'random_{line_type}_exact_detection')
