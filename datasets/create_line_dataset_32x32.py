...
import json
import configs.dataset_32x32_cfg as cfg
import sys, pdb
...
def main():
    ...
    print("#" * 50)
    print(f"Will create {num_images} images with {num_lines} {line_type}")
    print(f"H: {height}, W: {width}\nNum of pieces: {n_patches}")
    print("#" * 50)
    #################################

    dataset_path = os.path.join(os.getcwd(), 'data')
    cur_folder = os.path.join(dataset_path, f'random_{num_lines}_{line_type}_exact_detection_32x32')
    ...
    for N in range(num_images):
        ...
        puzzle_image_folder = os.path.join(os.getcwd(), 'output_32x32', f'random_{num_lines}_{line_type}_exact_detection')
