...
def usage(device=None):
    if device:
        Logger.error('Screen: The specified device ({0}) is unknown.',
                     device)
    print('\nModule usage: python User_Interface.py -m screen:deviceid[,orientation]\n')
    ...
    print('    python User_Interface.py -m screen:droid2\n')
    print('Simulate a high-density screen such as HTC One X, in portrait:\n')
    print('    python User_Interface.py -m screen:onex,portrait\n')
    print('Simulate the iPad 2 screen\n')
    print('    python User_Interface.py -m screen:ipad\n')
    print('If the generated window is too large, you can specify a scale:\n')
    print('    python User_Interface.py -m screen:note2,portrait,scale=.75\n')
    sys.exit(1)
