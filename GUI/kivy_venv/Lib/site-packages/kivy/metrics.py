...
X)::
    ...
    KIVY_DPI=320 KIVY_METRICS_DENSITY=2 python User_Interface.py --size 1280x720

Or a medium-density (like Motorola Droid 2)::

    KIVY_DPI=240 KIVY_METRICS_DENSITY=1.5 python User_Interface.py --size 854x480

You can also simulate an alternative user preference for fontscale as follows::

    KIVY_METRICS_FONTSCALE=1.2 python User_Interface.py
