...
def get_min_inflated_gt_fresco(gt_multi_polygon, inflation_width=0.00635, sf_factor=0.001, visualize=False,
                               save_plot=False):
    ...
    overlap = True
    while overlap == True:
        scaled_and_inflated_gt_multi_polygon, _ = scale_fresco(scaled_and_inflated_gt_multi_polygon,
