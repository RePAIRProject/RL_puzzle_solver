...
The relationship between User_Interface.py and test.kv is explained in
:meth:`App.load_kv`.
...
class App(EventDispatcher):
    ...
    def load_kv(self, filename=None):
        ...
        For example, say you have a file named User_Interface.py that contains::

            class ShowcaseApp(App):
                pass

        This method will search for a file named `showcase.kv` in
        the directory that contains User_Interface.py. The name of the kv file has to be
