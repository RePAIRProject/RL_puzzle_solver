...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='/home/sinem/PycharmProjects/User-Interface-Repair-Project/Pretrained_models/best.pt', help='model (.pt file)')
    parser.add_argument('--puzzle', type=str, default='/home/sinem/PycharmProjects/User-Interface-Repair-Project/Images/RePAIR_plaque_2/RGBA_merged', help='puzzle name (inside the data folder)')
