...
def main(args):
    ...
    dataset_name = f"synthetic_puzzle_{descr_string}_pieces_by_drawing_coloured_lines_{randomword(6)}"
    ...
    for N in range(num_images_to_be_created):
        ...
        img, all_lines = create_random_coloured_image(args.line_type, args.num_lines, args.height, args.width, thickness=args.thickness, num_colors=args.num_colors)
