...
def include_shape_info(fnames, pieces, dataset, puzzle, method, line_thickness=1, use_colors=False):
    ...
    for piece in pieces:
        ...
        drawn_lines = draw_lines(piece['extracted_lines'], piece['img'].shape, line_thickness, use_colors=use_colors)
