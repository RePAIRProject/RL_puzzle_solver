...
"""
from compatibility.regions_utils import RegionMatrixModule
...
def main(args):
    ...
    #                             a = dilate(a.astype(np.uint8), width=np.floor(1 * ppars.xy_step).astype(int))
    #                             b = dilate(b.astype(np.uint8), width=np.floor(1 * ppars.xy_step).astype(int))
