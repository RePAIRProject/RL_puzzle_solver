                ...
                if i == j:
                    ...
                    for t in range(grid_size_rot):
                        ...
                        if args.DEBUG is True:
                            ...
                            plt.subplot(6,3,11); plt.imshow(binary_overlap_lines); plt.title("Overlap Lines (mask)")
                            plt.subplot(6,3,12); plt.imshow(resized_lines); plt.title("Overlap Lines (resized)")
                            # combo
                            ...
                            # results
                            plt.subplot(6,3,16); plt.imshow(RM_lines[:,:,t,j,i]); plt.title("Lines")
